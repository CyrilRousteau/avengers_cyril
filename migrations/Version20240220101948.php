 ...
 */
final class Version20240220101948 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE marque_page ADD CONSTRAINT FK_19292F83855234A9 FOREIGN KEY (mot_cles_id) REFERENCES mots_cles (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
